...
cat("\n\n")
cat("**The preprocessing parameters were: ** \n")
cat("\n")
cat(paste0("`project id: ", preproc_params["project_id"],"`  \n"))
cat(paste0("`experiment id: ", preproc_params["experiment_id"],"`  \n"))
cat(paste0("`run id: ", preproc_params["run_id"],"` \n"))
cat(paste0("`raw data location: ", preproc_params["input"], "`  \n"))
cat(paste0("`well barcodes: ", preproc_params["barcodesFasta"],"`  \n"))
cat(paste0("`genome reference: ", preproc_params["genomeDir"],"`  \n"))
cat(paste0("`gtf annotation: ", preproc_params["annotation"],"`  \n"))
cat(paste0("`UMI length: ", preproc_params["umi_length"], "`"))
cat("</blockquote>")
